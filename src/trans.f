...
!     SCALING TO DISORT?
     ...
     &      KNTRVL,NLOS,SUNFUN,APPREF,DH2O,MLTRFL,GROUND,LABEL)
      ENDIF
...
!                 DISORT MULTIPLE SCATTERING AND FLUXES:
     ...
     &            FDNTRT,FDNRT,KNTRVL,PTHSCL,SURSCL,GROUND,TRNLOS,LABEL)
...
!                 DISORT:
     ...
     &              FDNTRT,FDNRTD,KNTRVL,GROUND,TRNLOS,BTERM,LABEL)
