...
!     OUTPUT ARGUMENTS:
!       IRETURN  0 = GOOD, 1 = BAD;  ADDED TO SKIP THE STOP ERROR AND CONTINUE
...
!             SPECTRAL WAVELENGTH => DECREASING SPECTRAL GRID:
              WDBEG=WDGRDI+WDPAD
              WDEND=WDGRDI-WDPAD
      print*, "2WDBEG, WDEND = ", WDBEG, WDEND
      print*, "NSPCDT = ", NSPCDT
      print*, "SPCGRD = ", SPCGRD
              DO J=1,NSPCDT-1
   ...
   20         CONTINUE
              ...
              ENDDO
!!            STOP 'Error in DEGRAD:  Not enough spectral data.'
              print*, 'Error in DEGRAD:  Not enough spectral data.'
!             IRETURN = 1
!             GOTO 60
          ENDIF
   30     CONTINUE
